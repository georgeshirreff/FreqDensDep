...
ward_intervals <- read_csv("data/FreqDens_ward_intervals_catHosp.csv"
...
cH_vec = ward_intervals$this_catHosp %>% unique
...
ward_nonlinear %>%  write_csv(paste0("analysis/ward_nonlinear_bayesIntensity_catHosp", analysis_index, ".csv"))
